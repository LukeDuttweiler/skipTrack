...
dat2 <- skipTrack.simulate(n = 100, model = 'skipTrack', skipProb = c(.75, .2, .05),
...
In this code we ask for 4 chains, each with 1000 iterations, run in parallel. Note that we recommend allowing the sampler to run longer than this (usually at least 5000 iterations per chain), but we use a short run here to save time.
